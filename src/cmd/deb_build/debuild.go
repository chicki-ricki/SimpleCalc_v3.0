...
func main() {
	...
	// artifacts[deb.ArchAmd64].MappedFiles = map[string]string{"/usr/bin/a": "build/bin/clevercalc-linux"}
...
func prep() error {
	...
	exesMap["amd64"] = []string{"_out/a.amd64"}
	exesMap["i386"] = []string{"_out/a.i386"}
	exesMap["armhf"] = []string{"_out/a.armhf"}
